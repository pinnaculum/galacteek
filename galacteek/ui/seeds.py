...
class SeedObjectTreeItem(QTreeWidgetItem):
    ...
    async def update(self, ipfsop):
        ...
        oController.fLayout()
        self.treeWidget().setItemWidget(self, self.COL_ACTIONS, oController)
        ...
        whoHasC = len(await ipfsop.whoProvides(self.objdescr['path']))
        self.status(iProvidedByPeers(whoHasC))
