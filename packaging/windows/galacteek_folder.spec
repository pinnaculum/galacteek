...
a = Analysis(['galacteek_win.py'],
    ...
    ('./packaging/windows/tor/tor-gencert.exe',
     '.'),
    ('./packaging/windows/tor/libevent-2-1-7.dll',
     '.'),
    ('./packaging/windows/tor/libssp-0.dll',
     '.'),
    ('./packaging/windows/tor/libcrypto-1_1-x64.dll',
     '.'),
    ('./packaging/windows/tor/libssl-1_1-x64.dll',
     '.'),
    ('./packaging/windows/tor/zlib1.dll',
     '.'),
    ('./packaging/windows/tor/libwinpthread-1.dll',
     '.')
    ],
    datas=[
