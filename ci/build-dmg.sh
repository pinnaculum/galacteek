...
cp /usr/local/Cellar/openssl@1.1/1.1.1*/lib/libssl*.dylib galacteek.app/Contents/Resources/lib
cp /usr/local/Cellar/openssl@1.1/1.1.1*/lib/libcrypto*.dylib galacteek.app/Contents/Resources/lib
